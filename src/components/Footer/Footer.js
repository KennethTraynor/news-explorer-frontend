        ...
        <footer className='footer'>
            <div className='footer__container'>
                ...
                <ul className='footer__icon-links'>
                    <li className='footer__icon-item'><a href='#github' className='footer__icon'><img src={githubIcon} alt="Github" /></a></li>
                    <li className='footer__icon-item'><a href="#facebook" className='footer_icon'><img src={facebookIcon} alt="Facebook" /></a></li>
                </ul>
            </div>
        </footer>
    )
